...
class MoveGenerator
{
    public:
        ...
        static vector<Move*> get_second_neighbourhood_candidate_moves(TPaths paths);
    private:
        ...
        static void add_candidate_edge_moves_from_path(TPath path, int path_id, vector<Move*>& moves);
        static void add_candidate_vertex_moves_from_paths(TPaths paths, vector<Move*>& moves);
};
